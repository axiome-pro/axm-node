...
const (
	Query_Validators_FullMethodName                    = "/axiome.staking.v1beta1.Query/Validators"
	Query_Validator_FullMethodName                     = "/axiome.staking.v1beta1.Query/Validator"
	Query_ValidatorDelegations_FullMethodName          = "/axiome.staking.v1beta1.Query/ValidatorDelegations"
	Query_ValidatorUnbondingDelegations_FullMethodName = "/axiome.staking.v1beta1.Query/ValidatorUnbondingDelegations"
	Query_Delegation_FullMethodName                    = "/axiome.staking.v1beta1.Query/Delegation"
	Query_UnbondingDelegation_FullMethodName           = "/axiome.staking.v1beta1.Query/UnbondingDelegation"
	Query_DelegatorDelegations_FullMethodName          = "/axiome.staking.v1beta1.Query/DelegatorDelegations"
	Query_DelegatorUnbondingDelegations_FullMethodName = "/axiome.staking.v1beta1.Query/DelegatorUnbondingDelegations"
	Query_Redelegations_FullMethodName                 = "/axiome.staking.v1beta1.Query/Redelegations"
	Query_DelegatorValidators_FullMethodName           = "/axiome.staking.v1beta1.Query/DelegatorValidators"
	Query_DelegatorValidator_FullMethodName            = "/axiome.staking.v1beta1.Query/DelegatorValidator"
	Query_HistoricalInfo_FullMethodName                = "/axiome.staking.v1beta1.Query/HistoricalInfo"
...
func (c *queryClient) EmissionRate(ctx context.Context, in *QueryEmissionRateRequest, opts ...grpc.CallOption) (*QueryEmissionRateResponse, error) {
	...
	err := c.cc.Invoke(ctx, Query_EmissionRate_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Query_EmissionRate_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Query_EmissionRate_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
