...
func init() {
	file_axiome_staking_v1beta1_authz_proto_init()
	md_StakeAuthorization = File_axiome_staking_v1beta1_authz_proto.Messages().ByName("StakeAuthorization")
...
func (x *StakeAuthorization) slowProtoReflect() protoreflect.Message {
	mi := &file_axiome_staking_v1beta1_authz_proto_msgTypes[0]
...
func (x *fastReflection_StakeAuthorization) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "axiome.staking.v1beta1.StakeAuthorization.max_tokens":
		return x.MaxTokens != nil
	case "axiome.staking.v1beta1.StakeAuthorization.allow_list":
		if x.Validators == nil {
			return false
	...
	case "axiome.staking.v1beta1.StakeAuthorization.deny_list":
		if x.Validators == nil {
			return false
	...
	case "axiome.staking.v1beta1.StakeAuthorization.authorization_type":
		return x.AuthorizationType != 0
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: axiome.staking.v1beta1.StakeAuthorization"))
		}
		panic(fmt.Errorf("message axiome.staking.v1beta1.StakeAuthorization does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_StakeAuthorization) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message axiome.staking.v1beta1.StakeAuthorization does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_StakeAuthorization) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "axiome.staking.v1beta1.StakeAuthorization.authorization_type":
		panic(fmt.Errorf("field authorization_type of message axiome.staking.v1beta1.StakeAuthorization is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: axiome.staking.v1beta1.StakeAuthorization"))
		}
...
func (x *fastReflection_StakeAuthorization) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	case "axiome.staking.v1beta1.StakeAuthorization.validators":
		if x.Validators == nil {
			return nil
		}
	...
	default:
		panic(fmt.Errorf("%s is not a oneof field in axiome.staking.v1beta1.StakeAuthorization", d.FullName()))
	}
	panic("unreachable")
}
...
func init() {
	file_axiome_staking_v1beta1_authz_proto_init()
	md_StakeAuthorization_Validators = File_axiome_staking_v1beta1_authz_proto.Messages().ByName("StakeAuthorization").Messages().ByName("Validators")
...
func (x *StakeAuthorization_Validators) slowProtoReflect() protoreflect.Message {
	mi := &file_axiome_staking_v1beta1_authz_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
			ms.StoreMessageInfo(mi)
...
func (x *fastReflection_StakeAuthorization_Validators) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "axiome.staking.v1beta1.StakeAuthorization.Validators.address":
		return len(x.Address) != 0
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: axiome.staking.v1beta1.StakeAuthorization.Validators"))
		}
		panic(fmt.Errorf("message axiome.staking.v1beta1.StakeAuthorization.Validators does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_StakeAuthorization_Validators) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message axiome.staking.v1beta1.StakeAuthorization.Validators does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_StakeAuthorization_Validators) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in axiome.staking.v1beta1.StakeAuthorization.Validators", d.FullName()))
	}
	panic("unreachable")
}
...
// 	protoc        (unknown)
// source: axiome/staking/v1beta1/authz.proto
...
func (AuthorizationType) Descriptor() protoreflect.EnumDescriptor {
	return file_axiome_staking_v1beta1_authz_proto_enumTypes[0].Descriptor()
}

func (AuthorizationType) Type() protoreflect.EnumType {
	return &file_axiome_staking_v1beta1_authz_proto_enumTypes[0]
}
...
func (AuthorizationType) EnumDescriptor() ([]byte, []int) {
	return file_axiome_staking_v1beta1_authz_proto_rawDescGZIP(), []int{0}
}
...
type StakeAuthorization struct {
	...
	AuthorizationType AuthorizationType `protobuf:"varint,4,opt,name=authorization_type,json=authorizationType,proto3,enum=axiome.staking.v1beta1.AuthorizationType" json:"authorization_type,omitempty"`
}
...
func (*StakeAuthorization_Validators) Descriptor() ([]byte, []int) {
	return file_axiome_staking_v1beta1_authz_proto_rawDescGZIP(), []int{0, 0}
}
...
var File_axiome_staking_v1beta1_authz_proto protoreflect.FileDescriptor

var file_axiome_staking_v1beta1_authz_proto_rawDesc = []byte{
	...
	0x22, 0xfa, 0x04, 0x0a, 0x12, 0x53, 0x74, 0x61, 0x6b, 0x65, 0x41, 0x75, 0x74, 0x68, 0x6f, 0x72,
	...
	0x01, 0x28, 0x0b, 0x32, 0x35, 0x2e, 0x61, 0x78, 0x69, 0x6f, 0x6d, 0x65, 0x2e, 0x73, 0x74, 0x61,
	...
	0x69, 0x73, 0x74, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x35, 0x2e, 0x61, 0x78, 0x69, 0x6f,
	...
	0x04, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x29, 0x2e, 0x61, 0x78, 0x69, 0x6f, 0x6d, 0x65, 0x2e, 0x73,
	...
	0x64, 0x72, 0x65, 0x73, 0x73, 0x3a, 0x48, 0xca, 0xb4, 0x2d, 0x22, 0x63, 0x6f, 0x73, 0x6d, 0x6f,
	...
	0x49, 0x46, 0x49, 0x45, 0x44, 0x10, 0x00, 0x12, 0x1f, 0x0a, 0x1b, 0x41, 0x55, 0x54, 0x48, 0x4f,
	0x52, 0x49, 0x5a, 0x41, 0x54, 0x49, 0x4f, 0x4e, 0x5f, 0x54, 0x59, 0x50, 0x45, 0x5f, 0x44, 0x45,
	0x4c, 0x45, 0x47, 0x41, 0x54, 0x45, 0x10, 0x01, 0x12, 0x21, 0x0a, 0x1d, 0x41, 0x55, 0x54, 0x48,
	...
	0x10, 0x04, 0x42, 0xea, 0x01, 0x0a, 0x1a, 0x63, 0x6f, 0x6d, 0x2e, 0x61, 0x78, 0x69, 0x6f, 0x6d,
	...
	,
}

var (
	file_axiome_staking_v1beta1_authz_proto_rawDescOnce sync.Once
	file_axiome_staking_v1beta1_authz_proto_rawDescData = file_axiome_staking_v1beta1_authz_proto_rawDesc
)

func file_axiome_staking_v1beta1_authz_proto_rawDescGZIP() []byte {
	file_axiome_staking_v1beta1_authz_proto_rawDescOnce.Do(func() {
		file_axiome_staking_v1beta1_authz_proto_rawDescData = protoimpl.X.CompressGZIP(file_axiome_staking_v1beta1_authz_proto_rawDescData)
	})
	return file_axiome_staking_v1beta1_authz_proto_rawDescData
}

var file_axiome_staking_v1beta1_authz_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_axiome_staking_v1beta1_authz_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_axiome_staking_v1beta1_authz_proto_goTypes = []interface{}{
	(AuthorizationType)(0),                // 0: axiome.staking.v1beta1.AuthorizationType
	(*StakeAuthorization)(nil),            // 1: axiome.staking.v1beta1.StakeAuthorization
	(*StakeAuthorization_Validators)(nil), // 2: axiome.staking.v1beta1.StakeAuthorization.Validators
	(*v1beta1.Coin)(nil),                  // 3: cosmos.base.v1beta1.Coin
}
var file_axiome_staking_v1beta1_authz_proto_depIdxs = []int32{
	3, // 0: axiome.staking.v1beta1.StakeAuthorization.max_tokens:type_name -> cosmos.base.v1beta1.Coin
	2, // 1: axiome.staking.v1beta1.StakeAuthorization.allow_list:type_name -> axiome.staking.v1beta1.StakeAuthorization.Validators
	2, // 2: axiome.staking.v1beta1.StakeAuthorization.deny_list:type_name -> axiome.staking.v1beta1.StakeAuthorization.Validators
	0, // 3: axiome.staking.v1beta1.StakeAuthorization.authorization_type:type_name -> axiome.staking.v1beta1.AuthorizationType
...
func init() { file_axiome_staking_v1beta1_authz_proto_init() }
func file_axiome_staking_v1beta1_authz_proto_init() {
	if File_axiome_staking_v1beta1_authz_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_axiome_staking_v1beta1_authz_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_axiome_staking_v1beta1_authz_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
	...
	file_axiome_staking_v1beta1_authz_proto_msgTypes[0].OneofWrappers = []interface{}{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_axiome_staking_v1beta1_authz_proto_rawDesc,
			NumEnums:      1,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_axiome_staking_v1beta1_authz_proto_goTypes,
		DependencyIndexes: file_axiome_staking_v1beta1_authz_proto_depIdxs,
		EnumInfos:         file_axiome_staking_v1beta1_authz_proto_enumTypes,
		MessageInfos:      file_axiome_staking_v1beta1_authz_proto_msgTypes,
	}.Build()
	File_axiome_staking_v1beta1_authz_proto = out.File
	file_axiome_staking_v1beta1_authz_proto_rawDesc = nil
	file_axiome_staking_v1beta1_authz_proto_goTypes = nil
	file_axiome_staking_v1beta1_authz_proto_depIdxs = nil
}
