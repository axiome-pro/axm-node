...
const (
	Msg_SetWithdrawAddress_FullMethodName          = "/axiome.distribution.v1beta1.Msg/SetWithdrawAddress"
	Msg_WithdrawDelegatorReward_FullMethodName     = "/axiome.distribution.v1beta1.Msg/WithdrawDelegatorReward"
	Msg_WithdrawValidatorCommission_FullMethodName = "/axiome.distribution.v1beta1.Msg/WithdrawValidatorCommission"
	Msg_FundCommunityPool_FullMethodName           = "/axiome.distribution.v1beta1.Msg/FundCommunityPool"
	Msg_UpdateParams_FullMethodName                = "/axiome.distribution.v1beta1.Msg/UpdateParams"
	Msg_CommunityPoolSpend_FullMethodName          = "/axiome.distribution.v1beta1.Msg/CommunityPoolSpend"
	Msg_DepositValidatorRewardsPool_FullMethodName = "/axiome.distribution.v1beta1.Msg/DepositValidatorRewardsPool"
)
