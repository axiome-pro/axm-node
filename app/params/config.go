...
func SetAddressPrefixes() {
	...
	// TODO: for compatibility, need to replace with setPurpose and setCoinType
	config.SetFullFundraiserPath("44'/546'/0'/0/0")
	config.SetCoinType(546)
