...
func NewDelegationDelegatorReward(valAddr string, reward sdk.DecCoins, emission sdk.DecCoins) DelegationDelegatorReward {
	return DelegationDelegatorReward{ValidatorAddress: valAddr, Reward: reward, Emission: emission}
}
