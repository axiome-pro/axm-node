...
// DecrementEmission mocks base method.
func (m *MockStakingKeeper) DecrementEmission(ctx context.Context, valAddr types0.ValAddress, amount math.LegacyDec) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "DecrementEmission", ctx, valAddr, amount)
	ret0, _ := ret[0].(error)
	return ret0
}

// DecrementEmission indicates an expected call of DecrementEmission.
func (mr *MockStakingKeeperMockRecorder) DecrementEmission(ctx, valAddr, amount interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "DecrementEmission", reflect.TypeOf((*MockStakingKeeper)(nil).DecrementEmission), ctx, valAddr, amount)
}
...
// MaximumMonthlyPoints mocks base method.
func (m *MockStakingKeeper) MaximumMonthlyPoints(ctx context.Context) (uint64, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "MaximumMonthlyPoints", ctx)
	ret0, _ := ret[0].(uint64)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// MaximumMonthlyPoints indicates an expected call of MaximumMonthlyPoints.
func (mr *MockStakingKeeperMockRecorder) MaximumMonthlyPoints(ctx interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "MaximumMonthlyPoints", reflect.TypeOf((*MockStakingKeeper)(nil).MaximumMonthlyPoints), ctx)
}

// UpdateEmissionPoints mocks base method.
func (m *MockStakingKeeper) UpdateEmissionPoints(ctx context.Context, del types.DelegationI, points uint64) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "UpdateEmissionPoints", ctx, del, points)
	ret0, _ := ret[0].(error)
	return ret0
}

// UpdateEmissionPoints indicates an expected call of UpdateEmissionPoints.
func (mr *MockStakingKeeperMockRecorder) UpdateEmissionPoints(ctx, del, points interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "UpdateEmissionPoints", reflect.TypeOf((*MockStakingKeeper)(nil).UpdateEmissionPoints), ctx, del, points)
}
...
// ValidatorEmissionRate mocks base method.
func (m *MockStakingKeeper) ValidatorEmissionRate(ctx context.Context) (math.LegacyDec, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ValidatorEmissionRate", ctx)
	ret0, _ := ret[0].(math.LegacyDec)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// ValidatorEmissionRate indicates an expected call of ValidatorEmissionRate.
func (mr *MockStakingKeeperMockRecorder) ValidatorEmissionRate(ctx interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ValidatorEmissionRate", reflect.TypeOf((*MockStakingKeeper)(nil).ValidatorEmissionRate), ctx)
}
