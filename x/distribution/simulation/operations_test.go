...
func (suite *SimTestSuite) SetupTest() {
	...
	suite.app, err = appsimtestutil.Setup(
		depinject.Configs(
...
func (suite *SimTestSuite) getTestingValidator0(accounts []simtypes.Account) stakingtypes.Validator {
	return suite.getTestingValidator(accounts, 0)
}

func (suite *SimTestSuite) getTestingValidator(accounts []simtypes.Account, n int) stakingtypes.Validator {
