...
func (msg MsgCreateValidator) Validate(ac address.Codec, minSelfDelegation math.Int) error {
...
func NewMsgEditValidator(valAddr string, description Description) *MsgEditValidator {
