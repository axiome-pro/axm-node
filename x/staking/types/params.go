...
func NewParams(unbondingTime, redelegationTime time.Duration,
	maxValidators, maxEntries, historicalEntries uint32,
	bondDenom string,
	maximumMonthlyPoints uint64,
	validatorEmissionRate math.LegacyDec,
	emissionTable []*EmissionRange,
	...
	return Params{
		...
		BondDenom:             bondDenom,
		MaximumMonthlyPoints:  maximumMonthlyPoints,
		ValidatorEmissionRate: validatorEmissionRate,
...
func DefaultParams() Params {
	return NewParams(
		...
		DefaultRedelegationTime,
		DefaultMaxValidators,
		DefaultMaxEntries,
		DefaultHistoricalEntries,
		sdk.DefaultBondDenom,
		DefaultMaximumMonthlyPoints,
		DefaultValidatorEmissionRate,
		[]*EmissionRange{&DefaultEmissionRange},
...
func (p Params) Validate() error {
	...
	if err := validateMaximumMonthlyPoints(p.MaximumMonthlyPoints); err != nil {
		return err
	}

	// TODO:add emission rate validation
	// TODO:add min self stake validation
	return nil
}
...
func validateMaximumMonthlyPoints(i interface{}) error {
	v, ok := i.(uint64)
	if !ok {
		return fmt.Errorf("invalid parameter type: %T", i)
	}
	...
	if v == 0 {
		return fmt.Errorf("maximum monthly points can't be zero: %d", v)
	}
