...
func SimulateMsgCreateValidator(
	...
	return func(
		...
		msg, err := types.NewMsgCreateValidator(address.String(), simAccount.ConsKey.PubKey(), selfDelegation, description)
		if err != nil {
...
func SimulateMsgEditValidator(
	...
	return func(
		...
		msg := types.NewMsgEditValidator(address, description)
