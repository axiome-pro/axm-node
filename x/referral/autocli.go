...
import (
	referralv1beta1 "github.com/axiome-pro/axm-node/api/axiome/referral/v1beta1"
			...
			RpcCommandOptions: []*autocliv1.RpcCommandOptions{
				{
					RpcMethod: "Params",
					Use:       "params",
					Short:     "Query the current referral parameters.",
				},
				{
					RpcMethod: "Get",
					Use:       "get [acc_address]",
					Short:     "Query referral info",
					Example:   fmt.Sprintf(`Example: $ %s query referral get [acc_address]`, version.AppName),

					PositionalArgs: []*autocliv1.PositionalArgDescriptor{
						{ProtoField: "acc_address"},
					},
				},
				{
					RpcMethod: "Exists",
					Use:       "exists [acc_address]",
					Short:     "Query registered account in referral module or not",
					Example:   fmt.Sprintf(`Example: $ %s query referral exists [acc_address]`, version.AppName),
				...
				{
					RpcMethod: "Children",
					Use:       "children [acc_address]",
					Short:     "Query account children in referral module",
					Example:   fmt.Sprintf(`Example: $ %s query referral children [acc_address]`, version.AppName),
				...
				{
					RpcMethod: "Coins",
					Use:       "coins [acc_address]",
					Short:     "Query account delegated coins calculated in referral module",
					Example:   fmt.Sprintf(`Example: $ %s query referral coins [acc_address]`, version.AppName),
