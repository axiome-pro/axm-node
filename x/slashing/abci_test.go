...
import (
	...
	"github.com/axiome-pro/axm-node/x/slashing"
	...
	stakingtestutil "github.com/axiome-pro/axm-node/x/staking/testutil"
...
func TestBeginBlocker(t *testing.T) {
	...
	params, _ := stakingKeeper.GetParams(ctx)
