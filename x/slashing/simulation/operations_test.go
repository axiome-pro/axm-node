...
import (
	...
	slashingkeeper "github.com/axiome-pro/axm-node/x/slashing/keeper"
	"github.com/axiome-pro/axm-node/x/slashing/simulation"
	"github.com/axiome-pro/axm-node/x/slashing/testutil"
...
func (suite *SimTestSuite) SetupTest() {
	...
	app, err := appsimtestutil.SetupWithConfiguration(
		depinject.Configs(
			testutil.AppConfig,
...
func getTestingValidator0(ctx sdk.Context, stakingKeeper *stakingkeeper.Keeper, accounts []simtypes.Account) (stakingtypes.Validator, error) {
	return getTestingValidator(ctx, stakingKeeper, accounts, 0)
}

func getTestingValidator(ctx sdk.Context, stakingKeeper *stakingkeeper.Keeper, accounts []simtypes.Account, n int) (stakingtypes.Validator, error) {
	account := accounts[n]
