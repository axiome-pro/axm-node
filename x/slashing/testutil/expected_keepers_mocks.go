...
func (m *MockParamSubspace) Get(ctx types0.Context, key []byte, ptr interface{}) {
	m.ctrl.T.Helper()
...
func (m *MockParamSubspace) GetParamSet(ctx types0.Context, ps types1.ParamSet) {
	m.ctrl.T.Helper()
...
func (m *MockParamSubspace) SetParamSet(ctx types0.Context, ps types1.ParamSet) {
	m.ctrl.T.Helper()
...
func (m *MockStakingKeeper) SlashWithInfractionReason(arg0 context.Context, arg1 types0.ConsAddress, arg2, arg3 int64, arg4 math.LegacyDec, arg5 types.Infraction) (math.Int, error) {
	m.ctrl.T.Helper()
